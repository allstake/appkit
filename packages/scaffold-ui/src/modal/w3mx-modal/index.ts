...
export class W3mModal extends LitElement {
  ...
  public override render() {
    return this.open
      ? html`
          <wui-flex @click=${this.onOverlayClick.bind(this)} data-testid="w3mx-modal-overlay">
            <wui-card
              shake="${this.shake}"
              role="alertdialog"
              aria-modal="true"
              tabindex="0"
              data-testid="w3mx-modal-card"
            >
              <w3mx-header></w3mx-header>
              <w3mx-router></w3mx-router>
              <w3mx-snackbar></w3mx-snackbar>
            </wui-card>
          </wui-flex>
          <w3mx-tooltip></w3mx-tooltip>
        `
      : null
  }
