import { ModalController } from '@web3modal-x/core'
import type { WuiConnectButton } from '@web3modal-x/ui'
import { customElement } from '@web3modal-x/ui'
import { LitElement, html } from 'lit'
import { property, state } from 'lit/decorators.js'
import { ifDefined } from 'lit/directives/if-defined.js'

@customElement('w3mx-connect-button')
...
declare global {
  interface HTMLElementTagNameMap {
    'w3mx-connect-button': W3mConnectButton
  }
}
