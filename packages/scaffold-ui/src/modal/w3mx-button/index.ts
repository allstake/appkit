import { AccountController, ModalController } from '@web3modal-x/core'
import { customElement } from '@web3modal-x/ui'
import { LitElement, html } from 'lit'
import { property, state } from 'lit/decorators.js'
import { ifDefined } from 'lit/directives/if-defined.js'
import type { W3mAccountButton } from '../w3mx-account-button/index.js'
import type { W3mConnectButton } from '../w3mx-connect-button/index.js'
import styles from './styles.js'

@customElement('w3mx-button')
