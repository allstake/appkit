...
import { AssetUtil, ChainController, ConnectorController, RouterController } from '@web3modal-x/core'
import { customElement } from '@web3modal-x/ui'
import { LitElement, html } from 'lit'
import { state } from 'lit/decorators.js'
import { ifDefined } from 'lit/directives/if-defined.js'

@customElement('w3mx-connect-multi-chain-widget')
...
declare global {
  interface HTMLElementTagNameMap {
    'w3mx-connect-multi-chain-widget': W3mConnectMultiChainWidget
  }
}
