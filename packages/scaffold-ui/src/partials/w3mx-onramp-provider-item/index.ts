...
import { customElement, type ColorType } from '@web3modal-x/ui'
import { AssetUtil, NetworkController, type OnRampProvider } from '@web3modal-x/core'
import styles from './styles.js'

@customElement('w3mx-onramp-provider-item')
...
declare global {
  interface HTMLElementTagNameMap {
    'w3mx-onramp-provider-item': W3mOnRampProviderItem
  }
}
