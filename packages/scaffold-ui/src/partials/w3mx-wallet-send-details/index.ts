...
import { AssetUtil, RouterController, type CaipNetwork } from '@web3modal-x/core'
import { ifDefined } from 'lit/directives/if-defined.js'

@customElement('w3mx-wallet-send-details')
...
declare global {
  interface HTMLElementTagNameMap {
    'w3mx-wallet-send-details': W3mWalletSendDetails
  }
}
