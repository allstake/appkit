...
@customElement('w3mx-account-default-widget')
export class W3mAccountDefaultWidget extends LitElement {
  ...
  public override render() {
    ...
    return html`<wui-flex
      ...
      <wui-flex flexDirection="column" gap="xs" .padding=${['0', 's', 's', 's'] as const}>
        ${this.authCardTemplate()} <w3mx-account-auth-button></w3mx-account-auth-button>
  ...
  private onrampTemplate() {
    ...
    return html`
      <wui-list-item
        data-testid="w3mx-account-default-onramp-button"
        iconVariant="blue"
        icon="card"
        ?chevron=${true}
  ...
  private authCardTemplate() {
    ...
    return html`
      <wui-notice-card
        ...
        icon="wallet"
        data-testid="w3mx-wallet-upgrade-card"
      ></wui-notice-card>
    `
  }
...
declare global {
  interface HTMLElementTagNameMap {
    'w3mx-account-default-widget': W3mAccountDefaultWidget
  }
}
