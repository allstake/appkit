...
import { ApiController, ConnectorController, RouterController } from '@web3modal-x/core'
...
@customElement('w3mx-all-wallets-search')
...
declare global {
  interface HTMLElementTagNameMap {
    'w3mx-all-wallets-search': W3mAllWalletsSearch
  }
}
