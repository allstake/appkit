...
import { ApiController, AssetUtil, ConnectorController, RouterController } from '@web3modal-x/core'
import { customElement } from '@web3modal-x/ui'
import { LitElement, html } from 'lit'
import { ifDefined } from 'lit/directives/if-defined.js'
import { WalletUtil } from '../../utils/WalletUtil.js'

@customElement('w3mx-connect-featured-widget')
...
declare global {
  interface HTMLElementTagNameMap {
    'w3mx-connect-featured-widget': W3mConnectFeaturedWidget
  }
}
