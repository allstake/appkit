import { AccountController, EventsController, RouterController } from '@web3modal-x/core'
...
@customElement('w3mx-account-tokens-widget')
...
declare global {
  interface HTMLElementTagNameMap {
    'w3mx-account-tokens-widget': W3mAccountTokensWidget
  }
}
