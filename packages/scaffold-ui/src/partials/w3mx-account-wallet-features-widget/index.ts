...
@customElement('w3mx-account-wallet-features-widget')
export class W3mAccountWalletFeaturesWidget extends LitElement {
  ...
  public override render() {
    if (!this.address) {
      throw new Error('w3mx-account-view: No account provided')
    }
    ...
    >
      ...
      <wui-profile-button
        ...
        data-testid="w3mx-profile-button"
      ></wui-profile-button>
      ${this.tokenBalanceTemplate()}
      <wui-flex gap="s">
        <w3mx-tooltip-trigger text="Buy">
          <wui-icon-button
            data-testid="wallet-features-onramp-button"
            @click=${this.onBuyClick.bind(this)}
            icon="card"
          ></wui-icon-button>
        </w3mx-tooltip-trigger>
        ${this.swapsTemplate()}
        <w3mx-tooltip-trigger text="Receive">
          <wui-icon-button
        ...
        <w3mx-tooltip-trigger text="Send">
          <wui-icon-button
  ...
  private swapsTemplate() {
    ...
    return html`
      <w3mx-tooltip-trigger text="Swap">
        <wui-icon-button
  ...
  private listContentTemplate() {
    if (this.currentTab === 0) {
      return html`<w3mx-account-tokens-widget></w3mx-account-tokens-widget>`
    }
    if (this.currentTab === 1) {
      return html`<w3mx-account-nfts-widget></w3mx-account-nfts-widget>`
    }
    if (this.currentTab === 2) {
      return html`<w3mx-account-activity-widget></w3mx-account-activity-widget>`
    }
...
declare global {
  interface HTMLElementTagNameMap {
    'w3mx-account-wallet-features-widget': W3mAccountWalletFeaturesWidget
  }
}
