import { DateUtil, type Transaction } from '@web3modal-x/common'
import {
  AccountController,
  AssetController,
  OnRampController,
...
@customElement('w3mx-onramp-activity-view')
...
declare global {
  interface HTMLElementTagNameMap {
    'w3mx-onramp-activity-view': W3mOnRampActivityView
  }
}
