import { ConnectorController } from '@web3modal-x/core'
...
@customElement('w3mx-update-email-wallet-view')
export class W3mUpdateEmailWalletView extends LitElement {
  ...
  private async onSubmitEmail(event: Event) {
    try {
      ...
      if (!authConnector) {
        throw new Error('w3mx-update-email-wallet: Auth connector not found')
      }
...
declare global {
  interface HTMLElementTagNameMap {
    'w3mx-update-email-wallet-view': W3mUpdateEmailWalletView
  }
}
