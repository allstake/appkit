...
import { NetworkController, RouterController, SendController } from '@web3modal-x/core'

@customElement('w3mx-wallet-send-preview-view')
...
declare global {
  interface HTMLElementTagNameMap {
    'w3mx-wallet-send-preview-view': W3mWalletSendPreviewView
  }
}
