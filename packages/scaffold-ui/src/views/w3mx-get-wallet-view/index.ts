import { ApiController, AssetUtil, CoreHelperUtil, OptionsController } from '@web3modal-x/core'
...
@customElement('w3mx-get-wallet-view')
...
declare global {
  interface HTMLElementTagNameMap {
    'w3mx-get-wallet-view': W3mGetWalletView
  }
}
