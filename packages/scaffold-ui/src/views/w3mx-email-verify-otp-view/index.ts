...
import type { OnOtpSubmitFn, OnOtpResendFn } from '../../utils/w3mx-email-otp-widget/index.js'
import {
  EventsController,
...
@customElement('w3mx-email-verify-otp-view')
...
declare global {
  interface HTMLElementTagNameMap {
    'w3mx-email-verify-otp-view': W3mEmailVerifyOtpView
  }
}
