import { AccountController, AssetUtil, CoreHelperUtil, NetworkController } from '@web3modal-x/core'
...
@customElement('w3mx-wallet-compatible-networks-view')
...
declare global {
  interface HTMLElementTagNameMap {
    'w3mx-wallet-compatible-networks-view': W3mWalletCompatibleNetworksView
  }
}
