...
import { ConstantsUtil } from '@web3modal-x/core'
import { LitElement, html } from 'lit'

@customElement('w3mx-upgrade-wallet-view')
    ...
    return html`
      <wui-flex flexDirection="column" alignItems="center" gap="xl" padding="xl">
        ...
        <wui-chip
          ...
          data-testid="w3mx-secure-website-button"
        >
        </wui-chip>
...
declare global {
  interface HTMLElementTagNameMap {
    'w3mx-upgrade-wallet-view': W3mUpgradeWalletView
  }
}
