...
export class W3mSwapView extends LitElement {
  ...
  private templateLoading() {
    return html`
      <wui-flex flexDirection="column" gap="l">
        <wui-flex flexDirection="column" alignItems="center" gap="xs" class="swap-inputs-container">
          <w3mx-swap-input-skeleton target="sourceToken"></w3mx-swap-input-skeleton>
          <w3mx-swap-input-skeleton target="toToken"></w3mx-swap-input-skeleton>
  ...
  private templateDetails() {
    ...
    return html`<w3mx-swap-details .detailsOpen=${this.detailsOpen}></w3mx-swap-details>`
  }
