import { customElement, MathUtil } from '@web3modal-x/ui'
import { LitElement, html } from 'lit'
import styles from './styles.js'
import { RouterController, SwapController, type SwapTokenWithBalance } from '@web3modal-x/core'
import { state } from 'lit/decorators.js'

@customElement('w3mx-swap-select-token-view')
...
declare global {
  interface HTMLElementTagNameMap {
    'w3mx-swap-select-token-view': W3mSwapSelectTokenView
  }
}
