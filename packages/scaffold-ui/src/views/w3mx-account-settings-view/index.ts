...
@customElement('w3mx-account-settings-view')
export class W3mAccountSettingsView extends LitElement {
  ...
  public override render() {
    if (!this.address) {
      throw new Error('w3mx-account-settings-view: No account provided')
    }
    ...
    return html`
      ...
      <wui-flex flexDirection="column" gap="m">
        <wui-flex flexDirection="column" gap="xs" .padding=${['0', 'l', 'm', 'l'] as const}>
          ...
          <w3mx-account-auth-button></w3mx-account-auth-button>
          <wui-list-item
...
declare global {
  interface HTMLElementTagNameMap {
    'w3mx-account-settings-view': W3mAccountSettingsView
  }
}
