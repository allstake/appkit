...
@customElement('w3mx-all-wallets-view')
export class W3mAllWalletsView extends LitElement {
  ...
  public override render() {
    ...
    return html`
      ...
      ${isSearch
        ? html`<w3mx-all-wallets-search query=${this.search}></w3mx-all-wallets-search>`
        : html`<w3mx-all-wallets-list></w3mx-all-wallets-list>`}
    `
  }
...
declare global {
  interface HTMLElementTagNameMap {
    'w3mx-all-wallets-view': W3mAllWalletsView
  }
}
