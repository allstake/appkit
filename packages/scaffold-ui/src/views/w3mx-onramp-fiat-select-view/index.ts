import { OnRampController, ModalController, AssetController } from '@web3modal-x/core'
import type { PaymentCurrency } from '@web3modal-x/core'
...
@customElement('w3mx-onramp-fiat-select-view')
...
declare global {
  interface HTMLElementTagNameMap {
    'w3mx-onramp-fiat-select-view': W3mOnrampFiatSelectView
  }
}
